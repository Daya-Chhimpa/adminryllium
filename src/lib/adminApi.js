const ADMIN_BASE_URL = process.env.NEXT_PUBLIC_ADMIN_API_BASE_URL || "https://api.satorem.com";
...
export const adminEndpoints = {
  ...
  blockUser: () => "/users/userblockbyadmin", // POST { userId }
  unblockUser: () => "/users/userunblockbyadmin", // POST { userId }
